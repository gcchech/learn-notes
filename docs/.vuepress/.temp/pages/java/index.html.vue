<template><div><h1 id="☕-java-技术指南" tabindex="-1"><a class="header-anchor" href="#☕-java-技术指南"><span>☕ Java 技术指南</span></a></h1>
<blockquote>
<p>从基础到进阶，系统掌握 Java 核心技术栈。</p>
</blockquote>
<h2 id="模块导航" tabindex="-1"><a class="header-anchor" href="#模块导航"><span>模块导航</span></a></h2>
<Catalog /><h2 id="学习路线" tabindex="-1"><a class="header-anchor" href="#学习路线"><span>学习路线</span></a></h2>
...
<p>建议按以下顺序学习：</p>
<ol>
<li><strong>Java 基础</strong> —— 掌握核心概念、基本语法、面向对象</li>
<li><strong>集合框架</strong> —— 理解容器体系，深入 HashMap、ArrayList 源码</li>
<li><strong>并发编程</strong> —— 线程池、锁机制、JUC 工具类</li>
<li><strong>JVM 原理</strong> —— 内存结构、GC、类加载</li>
<li><strong>Java 新特性</strong> —— Lambda/Stream、模块系统、虚拟线程</li>
</ol>
<h2 id="文章列表" tabindex="-1"><a class="header-anchor" href="#文章列表"><span>文章列表</span></a></h2>
<h3 id="📘-java-基础" tabindex="-1"><a class="header-anchor" href="#📘-java-基础"><span>📘 Java 基础</span></a></h3>
<ul>
<li><RouteLink to="/java/base/concept.html">Java 核心概念</RouteLink> — JVM/JDK/JRE、跨平台原理、编译与解释</li>
<li><RouteLink to="/java/base/syntax.html">Java 基本语法</RouteLink> — 注释、标识符、关键字、运算符详解</li>
<li>基本数据类型（即将更新）</li>
<li>面向对象编程（即将更新）</li>
</ul>
<h3 id="📗-集合框架" tabindex="-1"><a class="header-anchor" href="#📗-集合框架"><span>📗 集合框架</span></a></h3>
<ul>
<li>集合框架概览（即将更新）</li>
<li>ArrayList vs LinkedList（即将更新）</li>
<li>HashMap 深度解析（即将更新）</li>
</ul>
<h3 id="📙-并发编程" tabindex="-1"><a class="header-anchor" href="#📙-并发编程"><span>📙 并发编程</span></a></h3>
<ul>
<li>并发基础知识（即将更新）</li>
<li>线程池详解（即将更新）</li>
</ul>
<h3 id="📕-jvm" tabindex="-1"><a class="header-anchor" href="#📕-jvm"><span>📕 JVM</span></a></h3>
<ul>
<li>JVM 内存结构（即将更新）</li>
<li>垃圾回收（即将更新）</li>
</ul>
